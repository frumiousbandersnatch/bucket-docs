...
*(Rescued from [[https://web.archive.org/web/20170228183648/http://wiki.xkcd.com/wirc/index.php?title=Bucket&action=edit][archive.org]] and converted to [[file:bucket.org][Emacs org mode]] and then to HTML)*
